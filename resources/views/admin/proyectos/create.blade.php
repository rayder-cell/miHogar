...
<div class="card">
    <form method="POST" action="{{ route('admin.proyectos.store') }}" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" name="videos" value="{{ old('videos') }}" placeholder="https://www.youtube.com/embed/...">
        </div>

        <div class="form-group">
            <label>Link de Google Maps (embed)</label>
            <input type="text" name="mapa" value="{{ old('mapa') }}" placeholder="https://www.google.com/maps/embed?pb=...">
        </div>
