...
@section('content')
    ...
    <section class="hero-section">
        ...
        <div
            ...
            <p class="text-gold"
                style="font-size:clamp(0.75rem, 3vw, 1rem); letter-spacing:4px; text-transform:uppercase; margin-bottom:10px;">
                Bienvenido a
            </p>
            <h1 class="hero-titulo"
                style="color:var(--color-white); font-weight:900; text-transform:uppercase;
        ...
        <div
            style="position:absolute; bottom:20px; width:100%; display:flex; justify-content:center; gap:10px; z-index:10;">
    ...
    <div id="modal-verificacion"
        ...
        <div class="modal-inner border-gold">
            ...
            <p style="color:var(--color-gray); font-size:0.82rem; margin-bottom:15px;">
                ¿No recibiste el código? <a href="#" onclick="reenviarCodigo()" class="text-gold"
                    style="font-weight:bold;">Reenviar</a>
            </p>
