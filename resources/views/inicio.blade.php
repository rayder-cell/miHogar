...
<style>
    ...
    .btn-flecha-izq { left: 20px; }
    .btn-flecha-der { right: 20px; }
    ...
    @media (max-width: 768px) {
        ...
        .btn-flecha-izq { left: 8px; }
        .btn-flecha-der { right: 8px; }
...
<section class="hero-section">
    ...
    <div class="slide"
         style="background: {{ $proyecto->fotos ? 'url('.$proyecto->fotos.')' : '#1a1a1a' }};
                opacity: {{ $index === 0 ? '1' : '0' }};">
    ...
    <div style="position:absolute; top:0; left:0; width:100%; height:100%;
        ...
        <p class="text-gold" style="font-size:clamp(0.7rem, 2.5vw, 1rem); letter-spacing:4px; text-transform:uppercase; margin-bottom:10px;">
            Bienvenido a
        </p>
    ...
    <div class="hero-info-slide">
        ...
        <div class="info-slide" style="display:{{ $index === 0 ? 'block' : 'none' }};">
            <div class="border-left-gold" style="background:rgba(0,0,0,0.8); padding:12px 16px;">
                <h2 style="color:var(--color-white); font-size:clamp(0.8rem, 2.5vw, 1rem); margin-bottom:5px; line-height:1.3;">
