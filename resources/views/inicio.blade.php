...
<style>
    ...
    @media (max-width: 480px) {
        .btn-flecha-izq { left: 8px !important; }
        .btn-flecha-der { right: 8px !important; }
        .hero-info-slide { bottom: 55px !important; }
    }
    ...
    @media (max-width: 600px) {
        ...
        .contacto-form h3 { font-size: 1rem !important; }
        .redes-sociales { gap: 8px !important; }
    ...
    @media (max-width: 480px) {
        ...
        .nombre-row input { width: 100% !important; }
    }
    ...
    .codigo-inputs { display: flex; gap: 10px; justify-content: center; margin-bottom: 20px; }
    .codigo-input {
    ...
    /* ===== CHAT FLOTANTE ===== */
    @media (max-width: 480px) {
        #chat-flotante { bottom: 15px !important; right: 15px !important; }
...
<section class="hero-section">
    ...
    <div style="position:absolute; top:0; left:0; width:100%; height:100%;
        ...
        <p class="text-gold" style="font-size:clamp(0.75rem, 3vw, 1rem); letter-spacing:4px; text-transform:uppercase; margin-bottom:10px;">
            Bienvenido a
        </p>
        <h1 class="hero-titulo" style="color:var(--color-white); font-weight:900; text-transform:uppercase;
                   text-shadow:2px 2px 10px rgba(0,0,0,0.8); margin-bottom:15px;">
            Inmobiliaria Mi Hogar
        </h1>
        <p class="hero-subtitulo" style="color:var(--color-gray-light); margin-bottom:30px; max-width:min(600px, 90%);">
    ...
    @if ($proyectos->count() > 1)
        <button onclick="cambiarSlide(-1)" class="btn-flecha btn-flecha-izq"
        ...
        <button onclick="cambiarSlide(1)" class="btn-flecha btn-flecha-der"
        ...
        @foreach ($proyectos as $index => $proyecto)
            <div class="info-slide" style="display:{{ $index === 0 ? 'block' : 'none' }};">
                <div class="border-left-gold" style="background:rgba(0,0,0,0.75); padding:12px 16px; max-width:280px;">
                    <h2 style="color:var(--color-white); font-size:clamp(0.82rem, 3vw, 1rem); margin-bottom:6px;">
                        {{ $proyecto->nombre_proyecto }}
                    </h2>
                    <p style="color:var(--color-gray-light); font-size:0.8rem; margin-bottom:4px;">
                        📍 {{ $proyecto->distrito }} - {{ $proyecto->direccion }}
                    </p>
                    @if ($proyecto->precio)
                        <p class="text-gold" style="font-weight:bold; font-size:0.9rem; margin-bottom:8px;">
    ...
    <div class="contacto-wrapper">
        <div class="contacto-texto">
            ...
            <div class="redes-sociales" style="display:flex; gap:10px; margin-top:20px; flex-wrap:wrap;">
                ...
                <a href="https://wa.me/51932400015" target="_blank" style="display:flex; align-items:center; gap:6px; background:#25D366; color:#fff; padding:8px 14px; border-radius:6px; text-decoration:none; font-weight:bold; font-size:0.82rem;">
...
<section style="background:#fff; padding:60px 20px;">
    <div style="max-width:1100px; margin:0 auto;">
        <h2 style="text-align:center; color:#000; font-size:clamp(1.4rem, 5vw, 2rem); font-weight:900; margin-bottom:40px;">
...
<script>
    ...
    if (slides.length > 0) { mostrarSlide(0); setInterval(() => cambiarSlide(1), 5000); }
    ...
    function enviarFormulario() {
        ...
        .catch(() => { error.textContent = 'Error de conexión.'; error.style.display = 'block'; });
    }
    ...
    function reenviarCodigo() { cerrarModal(); setTimeout(() => enviarFormulario(), 300); }
</script>
@endsection