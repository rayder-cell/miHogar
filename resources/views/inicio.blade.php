...
@section('content')
            ...
            @foreach ($proyectos as $index => $proyecto)
                <div class="info-slide" style="display:{{ $index === 0 ? 'block' : 'none' }};">
                    <div class="border-left-gold" style="background:rgba(0,0,0,0.8); padding:10px 14px;">
                        <h2 style="color:var(--color-white); font-size:clamp(0.78rem, 2vw, 0.95rem); margin-bottom:4px; line-height:1.3;">
    ...
    <section style="background:var(--color-dark); padding:60px 20px;">
        <div class="contacto-wrapper">
            <div class="contacto-texto">
                <p class="text-gold"
                    style="font-size:0.9rem; letter-spacing:4px; text-transform:uppercase; margin-bottom:10px;">Contáctanos</p>
    ...
    <section style="background:#f0f0f0; padding:60px 0 40px;">
        <h2 style="text-align:center; color:#000; font-size:clamp(1.4rem, 5vw, 2rem); font-weight:900; margin-bottom:40px; padding:0 20px;">
                    ...
                    <div class="t-card">
                        <div class="t-card-inner">
                            ...
                            <div style="padding:18px;">
                                <p style="color:var(--color-gold); font-weight:900; font-size:0.95rem; margin-bottom:8px; line-height:1.4;">
                                    "{{ $t->titulo }}"
                                </p>
                                ...
                                <p style="color:#000; font-weight:bold; font-size:0.85rem; text-align:right; margin:0;">
                                    {{ $t->nombre }}<br>
                                    <span style="color:#888; font-weight:normal; font-size:0.78rem;">{{ $t->ubicacion }}</span>
                                </p>
                            </div>
                        </div>
                    </div>
