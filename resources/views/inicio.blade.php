...
@section('content')
    ...
    <section style="position:relative; min-height:90vh; overflow:hidden; background:var(--color-black);">
        ...
        @if ($proyectos->count() > 1)
            <button onclick="cambiarSlide(-1)" class="slider-btn"
                style="position:absolute;left:15px;top:50%;transform:translateY(-50%);background:rgba(0,0,0,0.5);border:2px solid var(--color-gold);color:var(--color-gold);font-size:2rem;cursor:pointer;width:50px;height:50px;border-radius:50%;z-index:10;">&#8249;</button>
            <button onclick="cambiarSlide(1)" class="slider-btn"
                style="position:absolute;right:15px;top:50%;transform:translateY(-50%);background:rgba(0,0,0,0.5);border:2px solid var(--color-gold);color:var(--color-gold);font-size:2rem;cursor:pointer;width:50px;height:50px;border-radius:50%;z-index:10;">&#8250;</button>
        @endif
