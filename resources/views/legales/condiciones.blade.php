...
<div style="max-width:900px; margin:60px auto; padding:0 20px;">
    ...
    <div style="color:#ddd; line-height:1.9; font-size:0.95rem;">
        ...
        <p>Al acceder y utilizar el sitio web de Inmobiliaria Mi Hogar Real State Perú S.A.C., usted acepta cumplir y estar sujeto a las siguientes condiciones de uso. Si no está de acuerdo con alguna de estas condiciones, le rogamos que no utilice nuestro sitio.</p>

        <h2 style="color:#c9a84c; font-size:1.2rem; margin:25px 0 10px;">2. Uso del sitio</h2>
        <p>Este sitio web es de uso exclusivamente informativo. Toda la información publicada sobre proyectos, precios y disponibilidad está sujeta a cambios sin previo aviso. Inmobiliaria Mi Hogar Real State Perú S.A.C. se reserva el derecho de modificar, suspender o discontinuar cualquier aspecto del sitio en cualquier momento.</p>

        <h2 style="color:#c9a84c; font-size:1.2rem; margin:25px 0 10px;">3. Propiedad intelectual</h2>
        <p>Todo el contenido de este sitio, incluyendo textos, imágenes, logotipos y diseños, es propiedad de Inmobiliaria Mi Hogar Real State Perú S.A.C. y está protegido por las leyes de propiedad intelectual vigentes en el Perú. Queda prohibida su reproducción total o parcial sin autorización expresa.</p>
        ...
        <p>Inmobiliaria Mi Hogar Real State Perú S.A.C. no será responsable por daños directos o indirectos derivados del uso o la imposibilidad de uso de este sitio web o de la información contenida en él.</p>
        ...
        <p>Para cualquier consulta relacionada con estas condiciones, puede contactarnos a través de: <span style="color:#c9a84c;">inmobiliariamihogarperu@gmail.com</span> o llamar al <span style="color:#c9a84c;">932 400 015</span>.</p>
    </div>
